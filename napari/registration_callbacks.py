...
# Callback we associate with the IterationEvent, update our data and display 
# new figure.    
def metric_and_reference_plot_values(registration_method, fixed_points, moving_points, canvas):
    global metric_values, multires_iterations, reference_mean_values
    global reference_min_values, reference_max_values
    global current_iteration_number
    ...
    print("iter", "mean error", current_iteration_number, mean_error)
    canvas.axes.cla()  # Clear the canvas.
    canvas.axes.plot(reference_mean_values, 'r')
